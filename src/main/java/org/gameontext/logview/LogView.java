 ...
 *******************************************************************************/
package org.gameontext.logview;
                ...
                if (basic.equalsIgnoreCase("Basic")) {
                    try {
                        ...
                        if (p != -1) {
                            ...
                            try {
                                expectedPassword = (String) new InitialContext().lookup("logViewKey");
                            ...
                            if ("admin".equals(login) && expectedPassword.equals(password)) {
                                ...
                                if ("list".equals(cmd)) {
                                    ...
                                    out.println("<center><h1>Welcome to LogView.</h1></center>"
                                            + "<center>Your friendly logging choice.</center><hr><p><p><center>This logging console is shoeware, you may use it, but you must <a href=\"https://www.amazon.ca/registry/wishlist/3OGMJ2X31EHP6\">buy Ozzy shoes</a>.</center><p><p>");
